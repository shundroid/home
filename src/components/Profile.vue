...
main
  ...
  section
    .description
      h3 shundroid
      | 2002年生まれ。今は大学生です。#[br]
      | I was born in 2002. Now I'm a university student.
      h3 趣味 / My hobby
      | プログラミング、数学、ピアノ、作問、耳コピ#[br]
      | Programming, Math, Piano, Creating questions for exams and Copy down tunes by ear.
      h3 プログラミングについて / Programming
